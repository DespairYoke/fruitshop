		...
		<div class="am-container header">
			...
			<div class="concent">
				...
				<div class="paycont">
                   ...
                   <span class="buy-user"><%=order.getUname()%></span>
										<span class="buy-phone"><%=order.getPhone() %></span>
										</span>
									</div>
						...
						<!--留言-->
							...
							<div class="buy-point-discharge ">
								<p class="price g_price ">
									合计（含运费） <span>¥</span><em class="pay-sum"><%=order.getPrice() %></em>
								</p>
							</div>
							...
							<div class="order-go clearfix">
								<div class="pay-confirm clearfix">
                                    ...
                                    <span>¥</span> <em class="style-large-bold-red " id="J_ActualFee"><%=order.getPrice() %></em>
											</span>
										</div>
